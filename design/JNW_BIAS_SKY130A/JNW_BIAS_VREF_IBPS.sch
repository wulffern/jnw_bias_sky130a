...
N 540 -750 540 -710 {lab=IBP_1U[1],N1[1:0]}
...
C {JNW_TR_SKY130A/JNWTR_RPPO16.sym} 540 -710 1 0 {name=xac3[2:0]}
...
C {JNW_TR_SKY130A/JNWTR_RPPO8.sym} 540 -560 1 0 {name=xac2}
C {JNW_TR_SKY130A/JNWTR_RPPO4.sym} 540 -450 1 0 {name=xac1}
C {JNW_TR_SKY130A/JNWTR_RPPO2.sym} 540 -350 1 0 {name=xac3}
