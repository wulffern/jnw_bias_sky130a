...
N 250 -220 250 -190 {lab=#net3}
N 150 -220 250 -220 {lab=#net3}
N 220 -280 220 -30 {lab=GND}
N -170 -300 -170 -200 {lab=GND}
N -280 -320 -170 -320 {lab=#net1}
N -280 -320 -280 -220 {lab=#net1}
N 130 -300 150 -300 {lab=#net4}
N 150 -300 150 -290 {lab=#net4}
N 150 -290 150 -280 {lab=#net4}
N 130 -280 150 -280 {lab=#net4}
N 180 -390 180 -320 {lab=GND}
N 130 -450 180 -450 {lab=#net5}
N 130 -450 130 -320 {lab=#net5}
