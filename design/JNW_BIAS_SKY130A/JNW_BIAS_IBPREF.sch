...
F {}
E {}
T {Constant 1.23 V reference 
with a PTAT current source} 200 -570 0 0 1 1 {}
...
N 570 -330 620 -330 {lab=VREF_1V23,IBP_1U[2:0]}
N 660 -90 660 -60 {lab=VSS}
N 660 -300 680 -300 {lab=VREF_1V23}
N 230 -60 660 -60 {lab=VSS}
N 230 -290 230 -60 {lab=VSS}
N 120 -310 240 -310 {lab=STARTUP_1V8}
N 120 -330 190 -330 {lab=VDD_1V8}
C {JNW_BIAS_SKY130A/JNW_BIAS_IBP.sym} 420 -310 0 0 {name=x2}
C {devices/ipin.sym} 120 -290 0 0 {name=p1 lab=VSS}
C {devices/opin.sym} 630 -370 0 0 {name=p3 lab=IBP_1U[2:0]}
C {cborder/border_xs.sym} 10 0 0 0 {user="Carsten Wulff" company="Carsten Wulff Software"}
C {JNW_BIAS_SKY130A/JNW_BIAS_IBP_VREF.sym} 660 -90 0 0 {name=x4}
C {devices/lab_wire.sym} 620 -330 0 1 {name=p6 sig_type=std_logic lab=VREF_1V23,IBP_1U[2:0]}
C {devices/lab_wire.sym} 680 -300 0 1 {name=p9 sig_type=std_logic lab=VREF_1V23}
C {devices/opin.sym} 890 -310 0 0 {name=p7 lab=VREF_1V23}
